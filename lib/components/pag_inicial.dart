                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TelaDetalhesCelular(celular: celular),
                      ),
                    );
                  },
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Armazenamento: ${celular['armazenamento'] ?? 'N/A'} GB'),
                          Text('Memória RAM: ${celular['memoria_ram'] ?? 'N/A'} GB'),
                          Text('Loja: ${celular['loja'] ?? 'N/A'}'),
                          Text('Preço Mínimo: R\$ ${celular['preco_minimo'] ?? 'N/A'}'),
                          Text('Preço de Venda: R\$ ${celular['preco_venda'] ?? 'N/A'}'),
                          const SizedBox(height: 4.0),
                          Text(
